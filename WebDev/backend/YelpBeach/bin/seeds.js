...
//the array of the initial entries
const beachesArr = [
    {
      name: "Glass Beach", 
      ...
      description: "+1 wolf thundercats franzen vice. Authentic enamel moon, normcore disrupt, ethical trade and cray lo-fi",
    }, 
    {
      name: "Fakistra", 
      ...
      description: "prism post-ironic, chillwave with pitchfork fashion. Some axe poke humblebrag. Smart party",
    },
    { 
      ...
      description: "coloring book literally, beard raclette cold-pressed with activated charcoal crucifix. Everyday carry bespoke fanny pack.",
    },
 ]
...
Beach.remove({}, (err, res) => {
    if (err) {
        ...
        //creating the initial entries from the beachesArr array to the DB 
